...
class Contact:
    ...
    def __init__(self, firstname=None, middlename=None, lastname=None, nickname=None, title=None, company=None, address=None,
                 ...
                 homepage=None, address2=None, secondaryphone=None,
    ...
    def __repr__(self):
        return "%s:%s:%s:%s:%s:%s:%s:%s" % (self.id, self.firstname, self.middlename, self.lastname, self.title, self.company, self.address, self.homephone)
